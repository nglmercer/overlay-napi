...
pub fn resize_image(
  ...
  let img = ImageBuffer::<Rgba<u8>, _>::from_raw(original_width, original_height, image_data.to_vec())
...
pub fn convert_pixel_format(
  ...
  match (from_format, to_format) {
    ...
    _ => Err(format!("Unsupported format conversion: {:?} to {:?}", from_format, to_format)),
  }
}
